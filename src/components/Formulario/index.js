...
function Formulario() {
  ...
  return (
    <div className="corpo">
        ...
        <h3>Preencha suas informações corretamente. Se tudo estiver certo, <br/> a ONG ou o responsável pelo animal entrará em contato.</h3>
      ...
      <form className="form" onSubmit={sendEmail}>
        ...
        <p><span>IMPORTANTE</span>: Abandonar, soltar, deixar fugir, não alimentar, acorrentar, bater, amedrontar e deixar acasalar indiscriminadamente são formas de maus tratos com pena prevista na lei. 
            ...
            Em caso de dúvidas, busque informações e auxílios de profissionais veterinários.</p>
